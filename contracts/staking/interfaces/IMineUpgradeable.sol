...
interface IMineUpgradeable {
  ...
  event Checkpoint(address indexed lpToken, uint256 indexed poolAmount, uint256 accPerShare);
  ...
  function setMainCoinFactory(address newFactory) external;
